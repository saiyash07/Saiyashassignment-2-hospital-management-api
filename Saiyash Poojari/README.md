...
> ⚠️ `availableBeds` cannot be greater than `totalBeds`.
...
3. Connect repo: `saiyash07/Saiyashassignment-2-hospital-management-api`
4. Set **Root Directory** → `Saiyash Poojari`
5. Build command: `npm install`
6. Start command: `npm start`
7. Add environment variable: `MONGO_URI` = your Atlas URI
